...
class ForumBotGUI(QMainWindow):
    ...
    def init_megathreads_view(self):
        ...
        self.megathreads_category_tree.setContextMenuPolicy(Qt.CustomContextMenu)
        self.megathreads_category_tree.customContextMenuRequested.connect(self.show_megathreads_category_context_menu)
    ...
    def init_posts_view(self):
        ...
        self.category_tree.setContextMenuPolicy(Qt.CustomContextMenu)  # Enable right-click menu
        ...
        self.thread_list.setContextMenuPolicy(Qt.CustomContextMenu)  # Enable right-click menu
        self.thread_list.customContextMenuRequested.connect(self.show_thread_context_menu)
